<?php
/**
* @version $Id: message.php 481 2007-12-25 fxstein $
* Fireboard Component
                ...
                <table width = "100%" border = "0" cellspacing = "0" cellpadding = "0">
                    ...
                    <tr>
                        <td colspan = "2" valign = "top">
                            ...
                            /* POLL System */ 
			      			if($poll_id>0) include_once($_SERVER['DOCUMENT_ROOT']."/components/com_fireboard/template/default/plugin/poll/showpoll.php");
